...
const Help =() => {
  return (
    <View>
      ...
      <Text style={styles.title2} >Sed ornare diam sed sodales fringilla?</Text>
      <Text style={} > Pellentesque sollicitudin suscipit ex, at fermentum diam mollis vel. Sed velit lectus, 
