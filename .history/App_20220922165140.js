...
const App =() => {
     return (
      <View style={styles.container} >
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed interdum orci at odio accumsan, in dignissim neque mollis.
         Morbi orci neque, congue nec porta in, lobortis et justo. Nunc est magna, dapibus eu venenatis sit amet, imperdiet ut est. 
         ut faucibus metus, et pharetra lorem. Nunc ornare odio neque, nec tincidunt sapien pellentesque sed. Suspendisse euismod nulla id nunc volutpat placerat. Sed rutrum tellus eget finibus pellentesque. Ut pulvinar egestas arcu ac consequat. Aenean luctus, eros et facilisis varius, sapien mi aliquam arcu, venenatis commodo leo urna a sapien. Mauris dapibus odio id iaculis cursus. Aenean nec convallis quam.
        </Text>
